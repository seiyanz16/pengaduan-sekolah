    ...
    <form action="{{ $register_url }}" method="post">
        ...
        <div class="input-group mb-3">
            <input type="text" name="nis" class="form-control @error('nis') is-invalid @enderror"
                value="{{ old('nis') }}" placeholder="{{ __('NIS') }}" autofocus>
        ...
        <div class="input-group mb-3">
            <input type="tel" name="telepon" class="form-control @error('telepon') is-invalid @enderror"
                value="{{ old('telepon') }}" placeholder="{{ __('Telepon') }}" autofocus>
        ...
        <div class="input-group mb-3">
            ...
            <div class="input-group-append">
                <div class="input-group-text">
                    <span class="fas fa-user-graduate {{ config('adminlte.classes_auth_icon', '') }}"></span>
                </div>
            </div>
